...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const xq_livox_interfaces::msg::CustomMsg::UniquePtr &msg, PointCloudXYZI::Ptr &pcl_out);
...
private:
  void avia_handler(const xq_livox_interfaces::msg::CustomMsg::UniquePtr &msg);
