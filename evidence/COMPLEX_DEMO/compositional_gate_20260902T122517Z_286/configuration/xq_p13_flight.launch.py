...
def generate_launch_description() -> LaunchDescription:
    ...
    arguments = [
        ...
        DeclareLaunchArgument(
            "integrity_information_memory_horizon_s", default_value="0.0"
        ),
        DeclareLaunchArgument(
            "integrity_information_memory_max_frames", default_value="20.0"
        ),
        ...
        DeclareLaunchArgument(
            "post_dynamic_static_confirmation_s", default_value="0.0"
        ),
        DeclareLaunchArgument("reversible_static_ttl_s", default_value="0.0"),
        DeclareLaunchArgument("maximum_rays", default_value="900"),
    ...
    nodes = [
        ...
        Node(
            ...
            parameters=[
                str(autonomy / "config" / "p6_integrity.yaml"),
                {
                    "information_memory_horizon_s": f(
                        "integrity_information_memory_horizon_s"
                    ),
                    "information_memory_max_frames": f(
                        "integrity_information_memory_max_frames"
                    ),
                },
            ],
        ),
        ...
        Node(
            ...
            parameters=[{
                ...
                "post_dynamic_static_confirmation_s": f(
                    "post_dynamic_static_confirmation_s"
                ),
                "reversible_static_ttl_s": f("reversible_static_ttl_s"),
                "maximum_rays": i("maximum_rays"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "enable_diagonal_vertical_candidates": b(
